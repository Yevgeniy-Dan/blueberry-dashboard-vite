...
const RoleForm = () => {
  ...
  const role = useAppSelector((state) => selectRoleById(state)(roleId || ""));
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (roleId) {
        dispatch(udpateRole({ roleId, role: roleRecord }));
        navigate("./../..");
      } else {
        dispatch(addRole(roleRecord));
        navigate("./..");
      }
    },
  });
              ...
              <div className="card-body">
                <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className="form-group mb-0">
                    ...
                    >
                      <i className="bi bi-file-arrow-down-fill me-2"></i> Save
                      Role
                    </button>
                  </div>
                </form>
